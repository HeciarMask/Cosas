...
class Habitacion extends Alojamiento {
	...
	toHTMLRow() {
		let salidaPadre = super.toSuperHTMLRow();
		let des = "No";
		if (this.desayuno == true) des = "Sí";
		let salida = salidaPadre.replace("</tr>", "") + "<td>" + des + "</td></tr>";
		return salida;
	}
}
...
class Agencia {
	...
	listadoHabitacion() {
		...
		res += "<table class='table'><thead>";
		res +=
			"<tr><th>Id Habitacion</th><th>Num Personas</th><th>Desayuno</th></tr>";
		res += "</thead><tbody>";
