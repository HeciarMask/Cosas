...
public class g_tablas_aux_postre {
...
return ((Map<String, Object>) tabla.getRowData()).get("id_postre").toString();
}


public ResultSet getRsTabla() {
String sc = "Select id_postre, nombre From " + stabla;
...
String sc = "Delete From " + stabla + " Where id_postre = " + sid_borrar;
...
String sc = "Update " + stabla + " Set nombre = '" + nombre_mod.getValue() + "' Where id_postre = " + ObtenerID();
MySQL_Util.Ej_ConsultaAccion(g_ocio.Conn, sc);
}
