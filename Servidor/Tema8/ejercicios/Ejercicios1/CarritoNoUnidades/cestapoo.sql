...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-01-2021 a las 09:24:07
...
drop database if exists CestaPoo;
CREATE DATABASE `CestaPoo` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `CestaPoo`;

--
-- Base de datos: `cestapoo`
--
...
--
ALTER TABLE `stock`
  ADD CONSTRAINT `stock_ibfk_1` FOREIGN KEY (`producto`) REFERENCES `producto` (`cod`),
  ADD CONSTRAINT `stock_ibfk_2` FOREIGN KEY (`tienda`) REFERENCES `tienda` (`cod`);
COMMIT;
